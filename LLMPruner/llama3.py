...
def main(args):
    ...
    if args.block_wise:
        kwargs = {
            ...
            "root_instances": [model.model.layers[i].self_attn.k_proj for i in root_layers] +
...
if __name__ == "__main__":
    ...
    if "Instruct" in args.base_model:
        scores.Passer.prune_strategy_save_path = "./ELASTICLLM/imp/Ours/llama3_instruct/{pth}/".format(pth=args.prune_pth)
    else:
        scores.Passer.prune_strategy_save_path = "./ELASTICLLM/imp/Ours/llama3/{pth}/".format(pth=args.prune_pth)
