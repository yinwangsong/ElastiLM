...
CUDA_VISIBLE_DEVICES=$1 python3 ./LLMPruner/hf_prune.py --base_model "lmsys/vicuna-7b-v1.5" --prune_pth $prune_ckpt_path --pruning_ratio 0.875 --device cpu  --eval_device cuda --block_wise --anchor_layers 4 3 2 31 1 0 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor --taylor param_first --save_model
