...
for ((i=0; i<${#prefill_slo[@]}; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama" --mode "LaCo" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama" --mode "ShortGPT" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama" --mode "AttnDrop" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama_LlamaTouch.txt"
...
CUDA_VISIBLE_DEVICES=$1 python ELASTICLLM/LlamaTouch.py --model "llama" --mode "LayerReduction" --prefill_SLO 1.0 --decode_SLO 1.0 --res_save_pth "ELASTICLLM/scripts/res/LlamaTouch.txt"
...
for ((i=0; i<${#prefill_slo[@]}; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama3" --mode "LaCo" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama3_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama3" --mode "ShortGPT" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama3_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama3" --mode "AttnDrop" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama3_LlamaTouch.txt"
...
CUDA_VISIBLE_DEVICES=$1 python ELASTICLLM/LlamaTouch.py --model "llama3" --mode "LayerReduction" --prefill_SLO 1.0 --decode_SLO 1.0 --res_save_pth "ELASTICLLM/scripts/res/LlamaTouch.txt"
...
for ((i=0; i<${#prefill_slo[@]}; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama3-instruct" --mode "LaCo" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama3_instruct_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama3-instruct" --mode "ShortGPT" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama3_instruct_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "llama3-instruct" --mode "AttnDrop" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/llama3_instruct_LlamaTouch.txt"
...
CUDA_VISIBLE_DEVICES=$1 python ELASTICLLM/LlamaTouch.py --model "llama3-instruct" --mode "LayerReduction" --prefill_SLO 1.0 --decode_SLO 1.0 --res_save_pth "ELASTICLLM/scripts/res/LlamaTouch.txt"
...
for ((i=0; i<${#prefill_slo[@]}; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "vicuna" --mode "LaCo" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/vicuna_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "vicuna" --mode "ShortGPT" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/vicuna_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "vicuna" --mode "AttnDrop" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/vicuna_LlamaTouch.txt"
...
CUDA_VISIBLE_DEVICES=$1 python ELASTICLLM/LlamaTouch.py --model "vicuna" --mode "LayerReduction" --prefill_SLO 1.0 --decode_SLO 1.0 --res_save_pth "ELASTICLLM/scripts/res/LlamaTouch.txt"
...
for ((i=0; i<${#prefill_slo[@]}; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "orca3b-mini" --mode "LaCo" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/orcamini_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "orca3b-mini" --mode "ShortGPT" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/orcamini_LlamaTouch.txt"
    CUDA_VISIBLE_DEVICES=$1 python3 ELASTICLLM/LlamaTouch.py --model "orca3b-mini" --mode "AttnDrop" --prefill_SLO ${prefill_slo[$i]} --decode_SLO ${decode_slo[$i]} --res_save_pth "ELASTICLLM/scripts/res/orcamini_LlamaTouch.txt"
...
CUDA_VISIBLE_DEVICES=$1 python ELASTICLLM/LlamaTouch.py --model "orca3b-mini" --mode "LayerReduction" --prefill_SLO 1.0 --decode_SLO 1.0 --res_save_pth "ELASTICLLM/scripts/res/LlamaTouch.txt"
