...
CUDA_VISIBLE_DEVICES=$1 python3 ./LLMPruner/hf_prune.py --base_model "huggyllama/llama-7b" --prune_pth $prune_ckpt_path --pruning_ratio 0.625 --device cpu  --eval_device cuda --block_wise --anchor_layers 7 4 1 0 5 31 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor --taylor param_first --save_model
