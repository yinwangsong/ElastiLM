...
CUDA_VISIBLE_DEVICES=$1 python3 ./LLMPruner/llama3.py --base_model "/data/share/Meta-Llama-3-8B" --prune_pth $prune_ckpt_path --pruning_ratio 0.9 --device cuda  --eval_device cuda --block_wise --anchor_layers 29 2 30 31 1 0 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor --taylor param_first --save_model
